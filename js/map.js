            ...
            case 'member':
                layer.bindPopup(
                    ...
                    <div>
                        ...
                        <p><i class="fa-solid fa-location-dot"></i> ${feature.properties.location}</p>
            ...
            case 'worksite':
                layer.bindPopup(
                    ...
                    <div>
                        <h3>${feature.properties.name}</h3>
                        <p><i class="fa-solid fa-location-dot"></i> ${feature.properties.location}</p>
                        <p><i class="fa-solid fa-user"></i> <a href="/forum/user/${feature.properties.author.username}">${feature.properties.author.name}</p>
                        <p><a href="/chantier/${feature.properties.id}">Voir le chantier</a></p>
                    </div>
                `,
                    { offset: [0, -5] }
                )
